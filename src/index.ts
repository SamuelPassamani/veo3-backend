...
router.get('/api/google-token', async () => {
  ...
  // ATENÇÃO: A chave privada do service account está hardcoded abaixo por opção do desenvolvedor.
  // Para produção, recomenda-se o uso de Secret do Wrangler para maior segurança.
